...
if __name__ == '__main__':
    ...
    model_CO = load_model(H5_PROD+'h5Files/Model_LSTM_CO_24hours.h5')
    model_NO2 = load_model(H5_PROD+'h5Files/Model_LSTM_NO2_24hours.h5')
    model_PM25 = load_model(H5_PROD+'h5Files/Model_LSTM_PM25_24hours.h5')
